...
public class WordActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDbHelper.open();
        String str = "SELECT * FROM tbl_5000ielts where keyword=\""+word+"\"";
        ...
        if (testCursor.moveToFirst()) {
            do {
                ...
                int i;
                final String definition=testCursor.getString(3);
                final String example=testCursor.getString(4);
                ...
                for (final String splitWord : defSplits) {
                    ...
                    ClickableSpan clickableSpan = new ClickableSpan() {
                        ...
                        public void onClick(View textView) {
                            ...
                            TestAdapter mDbHelper = new TestAdapter(WordActivity2.this);
                            mDbHelper.createDatabase();
                            mDbHelper.open();
                            ...
                            mDbHelper.close();
                            final Dialog md=new Dialog(WordActivity2.this);
                            ...
                            okbutton.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    LinterDB db=new LinterDB(WordActivity2.this);
                                    ...
                                    db.close();
                                    Toast.makeText(WordActivity2.this,"فیش افزوده شد",Toast.LENGTH_LONG).show();
                                    md.dismiss();
                                }
                            });
                ...
                TextView textView2 = (TextView) findViewById(R.id.partsOfSpeechTV);
                //defSS2.setSpan(new ForegroundColorSpan(Color.BLACK), 0, partsOfSpeech.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                textView2.setText(partsOfSpeech);
                ...
                persian=Html.fromHtml(translation).toString();
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(WordActivity2.this,"به جعبه لایتنر اضافه شد",Toast.LENGTH_LONG).show();
            }
        });
    }
