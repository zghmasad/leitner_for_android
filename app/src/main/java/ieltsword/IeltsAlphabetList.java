...
public class IeltsAlphabetList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Alphabet temp=new Alphabet("a",475);
        alphabets.add(temp);
        temp=new Alphabet("b",184);
        alphabets.add(temp);
        temp=new Alphabet("c",445);
        alphabets.add(temp);
        temp=new Alphabet("d",377);
        alphabets.add(temp);
        temp=new Alphabet("e",302);
        alphabets.add(temp);
        temp=new Alphabet("f",190);
        alphabets.add(temp);
        temp=new Alphabet("g",107);
        alphabets.add(temp);
        temp=new Alphabet("h",106);
        alphabets.add(temp);
        temp=new Alphabet("i",436);
        alphabets.add(temp);
        temp=new Alphabet("j",30);
        alphabets.add(temp);
        temp=new Alphabet("k",17);
        alphabets.add(temp);
        temp=new Alphabet("l",156);
        alphabets.add(temp);
        temp=new Alphabet("m",265);
        alphabets.add(temp);
        temp=new Alphabet("n",104);
        alphabets.add(temp);
        temp=new Alphabet("o",164);
        alphabets.add(temp);
        temp=new Alphabet("p",547);
        alphabets.add(temp);
        temp=new Alphabet("q",27);
        alphabets.add(temp);
        temp=new Alphabet("r",271);
        alphabets.add(temp);
        temp=new Alphabet("s",370);
        alphabets.add(temp);
        temp=new Alphabet("t",187);
        alphabets.add(temp);
        temp=new Alphabet("u",84);
        alphabets.add(temp);
        temp=new Alphabet("v",118);
        alphabets.add(temp);
        temp=new Alphabet("w",46);
        alphabets.add(temp);
        temp=new Alphabet("x",0);
        alphabets.add(temp);
        temp=new Alphabet("y",1);
        alphabets.add(temp);
        temp=new Alphabet("z",5);
        alphabets.add(temp);
        ...
        for(int index=0;index<26;index++){
            ...
            linearLayout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent i=new Intent(IeltsAlphabetList.this,IeltsWords.class);
                    i.putExtras(bdl);
                    startActivity(i);
                }
            });
