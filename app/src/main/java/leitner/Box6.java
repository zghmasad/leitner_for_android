...
public class Box6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<LitnerClass> tempList6=db.getBoxLitners(5,true);
        for(final LitnerClass lc:tempList6){
            ...
            ImageView updateImage=new ImageView(this);
            updateImage.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT,LinearLayout.LayoutParams.WRAP_CONTENT));
            updateImage.setImageResource(R.drawable.ic_refresh);
            updateImage.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    final Dialog md=new Dialog(Box6.this);
                    ...
                    alertTextView.setText("آیا می خواهید این فیش به جعبه باز گردد؟");
                    ...
                    yesbutton.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            LinterDB db=new LinterDB(Box6.this);
                            db.updateLeitnerBox(lc.English);
                            Toast.makeText(Box6.this,lc.English+" بازیافت شد",Toast.LENGTH_LONG).show();
                            md.dismiss();
                        }
                    });
                ...
                public void onClick(View view) {
                    ...
                    yesbutton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            Toast.makeText(Box6.this,lc.English+" حذف گردید",Toast.LENGTH_LONG).show();
                            md.dismiss();
                        }
                    });
    ...
    //
            ...
            childLinearLayout.addView(updateImage);
